...
def add_threat(crew):
    ...
    #another thing that i've noted is that there are is one function that can be disable either with a crew_science or a with a crew_medical, one option I've thought is the creation of another boolean
    ...
    boarding_ship = {'name': 'Boarding Ship', 'description': '-2 Hull Can be blocked if you use one tactial unit, but it gets sent to infirmary', 'dice_numbers': [3, 4], 'health': 4, 'attack': '2NM', 'volatility': False, 'assignable_crew': [CREW_TACTICAL, CREW_TACTICAL], 
    ...
    bomber2 = {'name': 'Bomber', 'description': '-1 Hull, send a unit to the infirmary', 'dice_numbers': [2,4], 'health': 2, 'attack': '1NM', 'volatility': False, 'assignable_crew': [CREW_TACTICAL], 
                'assigned_crew': [], 'block_till_complete': [], 'send_infirmary': True, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    
    bomber3 = {'name': 'Bomber', 'description': '-2 Hull, send a unit to the infirmary', 'dice_numbers': [2,4], 'health': 2, 'attack': '2NM', 'volatility': False, 'assignable_crew': [CREW_TACTICAL], 
                'assigned_crew': [], 'block_till_complete': [], 'send_infirmary': True, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    ...
    hijackers = {'name': 'Hijackers', 'description': '-2 Hull', 'dice_numbers': [4,5], 'health': 4, 'attack': '1NM', 'volatility': False, 'assignable_crew': [CREW_COMMANDER, CREW_COMMANDER, CREW_TACTICAL], 
                'assigned_crew': [], 'block_till_complete': [], 'send_infirmary': False, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    ...
    cosmic_existentialism = {'name': 'Cosmic Existentialism', 'description': 'Must be completed before assigning any other scientific crew', 'dice_numbers': [], 'health': -, 'attack': '', 'volatility': False, 'assignable_crew': [CREW_SCIENCE], 
                'assigned_crew': [], 'block_till_complete': [CREW_SCIENCE], 'send_infirmary': False, 'mercenary': False, 'existentialism': [True, CREW_SCIENCE], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    ...
    time_warp = {'name': 'Time Warp', 'description': 'All threats recover one damage', 'dice_numbers': [2], 'health': no_health_threat, 'attack': '', 'volatility': False, 'assignable_crew': [CREW_SCIENCE, CREW_SCIENCE], 
                'assigned_crew': [], 'block_till_complete': [], 'send_infirmary': False, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False, 'shields_online': False}  
    ...
    panel_explosion = {'name': 'Bomber', 'description': '-1 Hull, send a unit to the infirmary', 'dice_numbers': [3,4], 'health': no_health_threat, 'attack': '', 'volatility': False, 'assignable_crew': [CREW_MEDICAL], 
                'assigned_crew': [], 'block_till_complete': [CREW_ENGINEERING], 'send_infirmary': False, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    
    pandemic = {'name': 'Pandemic', 'description': 'send a unit to the infirmary', 'dice_numbers': [1], 'health': no_health_threat, 'attack': '', 'volatility': False, 'assignable_crew': [CREW_MEDICAL, CREW_SCIENCE], 
                'assigned_crew': [], 'block_till_complete': [], 'send_infirmary': True, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    
    invaders = {'name': 'Invaders', 'description': 'send a unit to the infirmary', 'dice_numbers': [2,4], 'health': no_health_threat, 'attack': '', 'volatility': False, 'assignable_crew': [CREW_TACTICAL, CREW_TACTICAL], 
                'assigned_crew': [], 'block_till_complete': [], 'send_infirmary': True, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    
    comms_offlime = {'name': 'Comms Offline', 'description': 'You may not assign commanders', 'dice_numbers': [], 'health': no_health_threat, 'attack': '', 'volatility': False, 'assignable_crew': [CREW_ENGINEERING], 
                'assigned_crew': [], 'block_till_complete': [CREW_COMMANDER], 'send_infirmary': False, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
    
    robot_uprising = {'name': 'Robot Uprising', 'description': 'Send unit to infirmary', 'dice_numbers': [1,2,3], 'health': no_health_threat, 'attack': '', 'volatility': False, 'assignable_crew': [CREW_ENGINEERING], 
                'assigned_crew': [], 'block_till_complete': [], 'send_infirmary': True, 'mercenary': False, 'existentialism': [False], 'return_scanner': False, 'stun': False, 'tactical_to_infirmary': False} 
