...
bomber2 = {'name': 'Bomber 2', 'description': '-1 Hull, send a unit to the infirmary', 'dice_numbers': [2,4], 'health': 2, 'attack': '1NM',  'assignable_crew': [], 
            'assigned_crew': [], 'block_till_complete': [], 'mission': True, 'stun': False} 

bomber3 = {'name': 'Bomber 3', 'description': '-2 Hull, send a unit to the infirmary', 'dice_numbers': [2,4], 'health': 2, 'attack': '2NM',  'assignable_crew': [], 
            'assigned_crew': [], 'block_till_complete': [], 'mission': True, 'stun': False} 
...
assault_cruiser2 = {'name': 'Assault Cruiser 2', 'description': '-2Hull', 'dice_numbers': [4,5], 'health': 4, 'attack': '2NM',  'assignable_crew': [], 
            'assigned_crew': [], 'block_till_complete': [], 'mission': False, 'stun': False}
            ...
            if threat['name'] == 'Distracted' and threat['stun'] == False:
                ...
                for member in crew:
                    ...
                    if member[i]['blocked'] == True and member[i]['infirmary'] == True:
                        member[i]['blocked'] == False and member[i]['infimary'] == False
...
def iterate_through_threats(active_threats, shield, health):
    throw_dice_result = throw_dice(1)
    for threat in active_threats:
        activate_threats(threat, shield, health, throw_dice_result)
